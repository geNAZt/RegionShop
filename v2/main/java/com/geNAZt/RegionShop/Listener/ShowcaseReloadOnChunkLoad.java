...
<<<<<<< HEAD:v2/main/java/com/geNAZt/RegionShop/Listener/ShowcaseReloadOnChunkLoad.java
...
>>>>>>> origin/master:src/main/java/com/geNAZt/RegionShop/Listener/ShowcaseReloadOnChunkLoad.java
                    ...
                    RegionShopPlugin.getInstance().getServer().getScheduler().scheduleSyncDelayedTask(RegionShopPlugin.getInstance(), new Runnable() {
                        ...
                        public void run() {
                            ...
                            //Drop the Item
                            org.bukkit.entity.Item droppedItem = event.getWorld().dropItem(new Location(event.getWorld(), (double) chest.getChestX() + 0.5, (double) chest.getChestY() - 0.8, (double) chest.getChestZ() + 0.5), itemStack);
                            droppedItem.setVelocity(new Vector(0, 0.1, 0));
                            droppedItem.setPickupDelay(Integer.MAX_VALUE);
                            NMS.safeGuard(droppedItem);
                        }
