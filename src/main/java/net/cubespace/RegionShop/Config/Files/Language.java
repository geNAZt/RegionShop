...
public class Language extends Config {
    public Language() {
        ...
        Command_Transcation_Header.add(ChatColor.YELLOW + "Legend: " + ChatColor.DARK_GREEN + "You have bought" + ChatColor.RESET + " - " + ChatColor.DARK_RED + "You have sold" + ChatColor.RESET + " - " + ChatColor.GOLD + "You have equipped" + ChatColor.RESET + " - " + ChatColor.YELLOW + "You added/set ItemMetaRepository" + ChatColor.RESET + " - " + ChatColor.DARK_AQUA + "You have removed");
    ...
    public String Command_Add_ChangeItem = ChatColor.RED + "ItemMetaRepository already added. " + ChatColor.DARK_RED + "/shop set %itemid sellprice buyprice amount" + ChatColor.RED + " to change it.";
    ...
    public String Command_Set_Success = ChatColor.GOLD + "ItemMetaRepository " + ChatColor.GREEN + "%itemname" + ChatColor.GOLD + " now sells for " + ChatColor.GREEN + "%sell" + ChatColor.GOLD + ", buys for " + ChatColor.GREEN + "%buy" + ChatColor.GOLD + ", per " + ChatColor.GREEN + "%amount" + ChatColor.GOLD + " unit(s)";
    ...
    //Sell Command
    public String Command_Sell_HelpText = ChatColor.GOLD + "/shop sell "+ ChatColor.RESET + ": Sell the current ItemMetaRepository in Hand to the shop";
    ...
    public String Command_Remove_NotYourItem = ChatColor.RED + "This is not your ItemMetaRepository";
    ...
    public String Command_Remove_Success = ChatColor.GOLD + "ItemMetaRepository has been removed from your Shop";
    public String Command_Remove_NotFound = ChatColor.RED + "No ItemMetaRepository found for this shopItemID";
    ...
    public String Sign_Customer_NotYourItem = ChatColor.RED + "You do not own this ItemMetaRepository";
