...
import com.geNAZt.RegionShop.Tasks.ShopListRegenerate;
...
public class ListStorage {
    ...
    public static void init(RegionShopPlugin pl) {
        ...
        task = new ShopListRegenerate(pl).runTaskTimerAsynchronously(pl, 0, 300 * 20);
    }
    ...
    public static void reload() {
        task.cancel();
        task = new ShopListRegenerate(plugin).runTaskTimer(plugin, 0, 300 * 20);
    }
