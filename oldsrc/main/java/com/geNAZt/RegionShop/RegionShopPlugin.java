...
import com.geNAZt.RegionShop.Database.Database.Manager;
import com.geNAZt.RegionShop.Database.Database.Model.*;
...
public class RegionShopPlugin extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        manager.addModel(ShopRegion.class);
        manager.addModel(ShopItems.class);

        database = manager.createDatabaseConnection();
